...
[StackTraceHidden]
[DebuggerStepThrough]
public static class OneFListExtensions
{
    ...
    /// <returns>
    /// Returns a new list ordered by dependencies. If A depends on B, then B will come before than
    /// A in the resulting list.
    /// </returns>
